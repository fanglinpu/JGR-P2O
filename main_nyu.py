...
parser.add_argument('--pose_dim', dest='pose_dim', type=int, default=42, help='dimentions of hand pose')
parser.add_argument('--num_jnt', dest='num_jnt', type=int, default=14, help='# of hand joints')
parser.add_argument('--log_dir', dest='log_dir', default='./log/NYU', help='logs are saved here')
parser.add_argument('--checkpoint_dir', dest='checkpoint_dir', default='./checkpoint/NYU/dense_offset_graph_A', help='models are saved here')
parser.add_argument('--lr', dest='lr', type=float, default=0.0002, help='initial learning rate for adam')
parser.add_argument('--epoch', dest='epoch', type=int, default=58, help='# of epoch')
parser.add_argument('--dataset', dest='dataset', default='NYU', help='dataset')
...
parser.add_argument('--data_root', dest='data_root', default='/home/data/3D_hand_pose_estimation/NYU/dataset/', help='dataset are saved here')
...
def main(_):
    ...
    if args.dataset == 'NYU':     
      if args.phase == 'train':
        di_train = NYUImporter(args.data_root, cacheDir='./cache/NYU/',refineNet=None, allJoints=False)
        Seq_train = di_train.loadSequence('train', rng=rng, shuffle=False, docom=False, cube=None)
    ...
    di_test = NYUImporter(args.data_root, cacheDir='./cache/NYU/',refineNet=None, allJoints=False)
